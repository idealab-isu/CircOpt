function [x0, lb, ub, scaling] = paramsDogRef(params)
...
%   paramsBiVRef({'avail'}) returns a list of all available parameters
...
varRef = struct( ...
    'scalep0'         , [1                        ,  0.75,    1.25, 1  ], ... % (-) Scale mean arterial pressure from 33% rule
